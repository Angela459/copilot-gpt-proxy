...
from copilot_gpt_proxy.tunnel import (
    NgrokTunnel,
    local_tunnel_target,
    ngrok_agent_urls,
...
class TunnelTests(unittest.TestCase):
    ...
    def test_ngrok_tunnel_appends_url_flag_when_configured(self) -> None:
        with patch("copilot_gpt_proxy.tunnel.shutil.which", return_value="/x/ngrok"):
            with patch("copilot_gpt_proxy.tunnel.subprocess.Popen") as popen:
